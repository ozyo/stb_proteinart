...
proc angle_proj { tm_vec tm_center z_vec all_center } {
    ...
    set dot [vecdot $tm_vec $x_vec]
    set tm_proj_xy [vecsub $tm_vec [vecscale $dot $x_vec]]
...
set TM2_A [atomselect 5 " chain A and resid 242 to 265 and name CA" frame 0]
set TM2_B [atomselect 5 " chain B and resid 242 to 265 and name CA" frame 0]
set TM2_C [atomselect 5 " chain C and resid 242 to 265 and name CA" frame 0]
set TM2_D [atomselect 5 " chain D and resid 242 to 265 and name CA" frame 0]
set TM2_E [atomselect 5 " chain E and resid 242 to 265 and name CA" frame 0]
...
set output_file [open [lindex $argv 2].dat w]

for {set frame 0} {$frame < $num_steps} {incr frame} {
    set TM2_A [atomselect 5 " chain A and resid 242 to 265 and name CA" frame $frame]
    set TM2_B [atomselect 5 " chain B and resid 242 to 265 and name CA" frame $frame]
    set TM2_C [atomselect 5 " chain C and resid 242 to 265 and name CA" frame $frame]
    set TM2_D [atomselect 5 " chain D and resid 242 to 265 and name CA" frame $frame]
    set TM2_E [atomselect 5 " chain E and resid 242 to 265 and name CA" frame $frame]
